...
G4bool HepMCInterface::CheckVertexInsideWorld(const G4ThreeVector& pos) const
{
...
void HepMCInterface::HepMC2G4(const HepMC::GenEvent* hepmcevt,G4Event* g4event)
{
...
HepMC::GenEvent* HepMCInterface::GenerateHepMCEvent()
{
...
void HepMCInterface::GeneratePrimaryVertex(G4Event* anEvent)
{
  // delete previous event object
  delete m_hepmcEvent;

  // generate next event
  m_hepmcEvent= GenerateHepMCEvent();
  if(! m_hepmcEvent) {
