...
class HepMCInterface : public G4VPrimaryGenerator {
 
  public:
    HepMCInterface();
    virtual ~HepMCInterface();
  ...
  protected:
    ...
    HepMC::GenEvent* m_hepmcEvent; // (care for single event case only)
...
inline HepMC::GenEvent* HepMCInterface::GetHepMCGenEvent() const
{
  return m_hepmcEvent;
}
